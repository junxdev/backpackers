...
<%@include file="../template/head.jspf" %>   
        ...
        <title>관리자 페이지</title>
        <link rel="icon" type="image/x-icon" href="resources/assets2/img/favicon.ico" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                ...
                <span class="d-none d-lg-block"><img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="resources/assets2/img/profile.jpg" alt="" /></span>
            </a>
                ...
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            ...
                            <div class="subheading mb-3">글 관리</div>
            ...
            <section class="resume-section" id="shop">
                <div class="resume-section-content">
                 ...
                 <!--       <div class="subheading mb-3">Bachelor of Science</div> -->
                            <a class="btn btn-default" href="${root}/admin/addproduct" role="button">상품 등록</a>
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between">
                        <div class="flex-grow-1">
                            ...
                            <a class="btn btn-default" href="${root}/admin/deleteproduct" role="button">상품 수정/삭제</a>
