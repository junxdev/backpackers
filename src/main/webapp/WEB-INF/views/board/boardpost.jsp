...
<a href="./${boardDitail.board_no}/edit" class="btn btn-primary" id="contentupdate" role="button">글수정</a>
...
<td style="width: 70%;" id="replyContent"><input type="text" value="${reply.reply_content}"  id="reply_content" name="reply_content" ></td>
<td style="width: 10%;"><fmt:formatDate value="${reply.reply_time}" pattern="yyyy-MM-dd"/></td>
