...
<body>
   <div class="container">
      ...
      <form <%-- action="${root}/user/registerEdit"  --%>method="post" id="registerPage">
         아이디<div class="form-group has-feedback">
            <input type="text" id="userId" name="userId" value="${user.userId}"  class="form-control">
               

         <div class="form-group has-feedback">
            <input type="text" id="userName" name="userName"
               class="form-control" value="${user.userName}"> <span
               class="glyphicon glyphicon-user form-control-feedback"></span>
         </div>
         <div class="form-group has-feedback">
            <input type="email" id="userEmail" for="signupEmail" maxlength="50"
               name="userEmail" class="form-control" value="${user.userEmail}"> <span
               class="glyphicon glyphicon-envelope form-control-feedback"></span>
         </div>
         <div class="form-group has-feedback">
            <input type="password" id="userPw" name="userPw"
               class="form-control" value="${user.userPw}"> <span
        ...
        <button type="submit" id="btn1" ><a href="${root}/user/delete">회원탈퇴</a></button>
		<button type="submit" id="btn1" ><a href="${root}/user/registerEdit">회원정보수정</a></button> 
