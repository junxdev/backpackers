		...
		<div id="loginForm" style="margin-top: 5%;">
	        ...
	        <h3 style="white">비밀번호 찾기</h3>
					  <form action="/backpackers/user/pwModify" method="POST">
				            <br>
				       아이디 <input id="userId" name="userId" class="lostInput" type="text"></p>
				       ...
				       이메일 <input id="userEmail" name="userEmail" class="lostInput" type="text"></p>
			    		...
			    		<p><input type="password" id="userPw" name="userPw" placeholder="비밀번호" style="font-size: 13px; color: black; text-align: center; display:none;"></p>
			    		<p><input type="password" id="userPw_check" placeholder="비밀번호 확인" name="userPw_check" required="required" style="font-size: 13px; color: black; text-align: center; display: none;"></p>
