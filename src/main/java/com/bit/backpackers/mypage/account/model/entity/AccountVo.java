package com.bit.backpackers.mypage.account.model.entity;
...
public class AccountVo {
	...
	public String toString() {
		return "AccountVo [userId=" + userId + ", userPw=" + userPw + ", userName=" + userName + ", userEmail="
				+ userEmail + ", postCode=" + postCode + ", address=" + address + ", detailAddress=" + detailAddress
				+ ", extraAddress=" + extraAddress + ", phoneNum=" + phoneNum + "]";
	}
	public AccountVo(String userId, String userPw, String userName, String userEmail, int postCode, String address,
			String detailAddress, String extraAddress, String phoneNum) {
		super();
		this.userId = userId;
		this.userPw = userPw;
		this.userName = userName;
