...
public class BoardController {
	...
	BoardService boardService;
	 ...
	 public String boardupdate(@PathVariable int board_no,@ModelAttribute BoardVo info) throws SQLException {
	 ...
	 @RequestMapping(value = "{board_no}",method =RequestMethod.DELETE)
		 public String delboard(@PathVariable int board_no) throws SQLException {
